...
public class XutilsHttp {
    ...
    public void bindCommonImage(ImageView iv, String url, boolean option) {
        if (option) {
            options = new ImageOptions.Builder().setLoadingDrawableId(R.mipmap.duanwang_icon).setFailureDrawableId(R.mipmap.duanwang_icon).setImageScaleType(ImageView.ScaleType.FIT_XY).build();
